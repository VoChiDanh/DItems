...
public class ArmorEquipEvent extends PlayerEvent {
     ...
     * @param oldArmor The ItemStack of the armor removed.
     * @param newArmor The ItemStack of the armor added.
     */
    ...
    public enum ArmorType {
        ...
        public static ArmorType matchType(ItemStack item) {
            ...
            if (name.endsWith("HELMET") || name.endsWith("SKULL") || name.endsWith("HEAD") || type.isBlock())
                return HELMET;
